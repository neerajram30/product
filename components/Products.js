...
<Grid templateColumns={{md:'repeat(4, 1fr)',sm:'repeat(1, 1fr)' }} gap={6} ml={{md:"75px",sm:"30px",base:"10px"}} mr={{md:"75px",sm:"30px", base:"10px"}} mt={10} >
    {
      data.allProducts.products && data.allProducts.products.map((product,i)=>
          ...
          <Box key={i} bg="blackAlpha.200" mt={1} border="1px" borderColor='blackAlpha.200' borderRadius='sm'>
              ...
              <Image src={product.image} width='125px' height='auto' bg="blackAlpha.200"/>
              </Center>
